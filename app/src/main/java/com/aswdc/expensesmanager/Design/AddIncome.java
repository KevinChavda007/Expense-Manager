...
public class AddIncome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spSelectcategory =(Spinner)findViewById(R.id.in_sp_category);
        etAmount = (EditText) findViewById(R.id.in_et_amount);
        etDate = (EditText) findViewById(R.id.in_et_date);
        etDescription = (EditText) findViewById(R.id.in_et_description);
        spPaymentmethod =(Spinner)findViewById(R.id.in_sp_payment_method);
        btnAdd = (Button) findViewById(R.id.in_btn_add);
        btnReset = (Button) findViewById(R.id.in_btn_reset);
        ...
        arrayCategory=dbc.selectAllCategory(Constant.INCOME);
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d("i", i + "");
                bt.setCategoryID(i);
                bt.setExpenseTypeID(Constant.INCOME);
                if (flag == 0) {
                    Intent in = new Intent(AddIncome.this, DashboardActivity.class);
                    startActivity(in);
                    dbt.insert(bt);
                    Toast.makeText(AddIncome.this, "Saved!", Toast.LENGTH_LONG).show();
